...
public class AcreditacionHome {
	...
	public Acreditacion findById(int id) {
		...
		try {
			...
			Acreditacion instance = (Acreditacion) sessionFactory
					.getCurrentSession().get("com.acreditaciones.core.bean.Acreditacion", id);
			if (instance == null) {
	...
	public List<Acreditacion> findByExample(Acreditacion instance) {
		...
		try {
			...
			Criteria criteria = sessionFactory.getCurrentSession().createCriteria("com.acreditaciones.core.bean.Acreditacion");
